                        ...
                        if (!empty($listofTickets)) {
                            ...
                            foreach ($listofTickets as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" id="responsible_person_<?php echo $row['ticket_id']; ?>"><?php echo ucwords(stripslashes($row['responsible_person'])); ?></td>
                                    ...
                                    <td class="text-center" id="subject_<?php echo $row['ticket_id']; ?>"><a href="<?php echo base_url() . FN_LIST_TICKET_REPLY . '/' . $row['ticket_id']; ?>"><i class="fa fa-reply" ></i></a></td>
                                    <td style="text-align: center;">
                                        <a onclick="javascript:getDetails(<?php echo $row['ticket_id']; ?>)"data-toggle="modal" href="#ticket_details"><i class="fa fa-edit"></i></a>
                                        |&nbsp;
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <input id="submit" type="submit" class="btn green" value="Update">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ($.trim(data).length) {
                       ...
                       // alert(resp.data.responsible_person);
                        if (resp.success) {
...
//        $('input[name=resolve_day]').val();
    ...
    $(document).ready(function () {
        ...
        $('#form_sample_1').on('submit', function (e) {
            ...
            var priority_text = $("#priority option:selected").text();
            ...
            $.ajax({
                ...
                cache: false,
                processData: false,
                url: '<?php echo base_url() . FN_TICKET_SAVE_DETAILS; ?>',
                success: function (data) {
                    //alert(data);
                    if ($.trim(data).length) {
                        var resp = $.parseJSON(data);
                        if (resp.success) {
                            ...
                            $('#priority_' + ticket_id).html(stripslashes(priority_text));
                            $('#responsible_person_' + ticket_id).html(stripslashes(responsible_person_text));
                            setTimeout(function () {
