    ...
    <div class="col-md-12">
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cube fa-lg"></i>Events
                </div>
            </div>
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a class="btn yellow-gold" data-toggle="modal" href="#add_event">
                        ...
                        if (!empty($events)) {
                            ...
                            foreach ($events as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo date_format(new DateTime($row['date_start']), CONST_DATE_FORMAT_DMY); ?></td>
                                    <td class="text-center"><?php echo date_format(new DateTime($row['date_end']), CONST_DATE_FORMAT_DMY); ?></td>
                                    <td class="text-center"><?php echo $row['is_ongoing'] == CONST_ACTIVATE ? 'Active' : 'Inactive' ?></td>
                                    <td style="text-align: center;">
                                        <a onclick="javascript:getDetails(<?php echo $row['id']; ?>)"data-toggle="modal" href="#add_event"><i class="fa fa-edit"></i></a>
                                        |&nbsp;
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-4">Event Name <span class="required">* </span></label>
                                    <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-md-4">Start Date</label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-md-4">End Date</label>
                                <div class="col-xs-12 col-md-4">
